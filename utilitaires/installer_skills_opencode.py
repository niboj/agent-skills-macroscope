...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Installer les skills du depot dans un repertoire global de skills compatible OpenCode."
    )
    parser.add_argument("--skills-root", default="skills", help="Repertoire source des skills")
    parser.add_argument(
        "--target-dir",
        default="~/.config/opencode/skills",
        help="Repertoire de destination. Par defaut : ~/.config/opencode/skills",
    )
