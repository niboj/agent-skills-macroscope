# Référence du livrable P2412 AG.2.1.2 - Tenir la réunion de lancement de la livraison

## Source analysée

- Fichier source : `../../../macroscope/livrables/dc5aa8b74616.md`
...
- Présenter P2412 AG.2.1.2 - Tenir la réunion de lancement de la livraison comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
...
* Chef de projet: Produit * Équipe du projet: Contribue
