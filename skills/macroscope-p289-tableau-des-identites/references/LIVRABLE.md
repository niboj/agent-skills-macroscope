# Référence du livrable P289 Tableau des identités

## Source analysée

- Fichier source : `../../../macroscope/livrables/6c0f42fbef5a.md`
...
- S'assure que chaque objet n'est chargé qu'une seule fois en les conservant dans un tableau.
- Utilise ce tableau pour la recherche des objets chargés.
...
- Présenter P289 Tableau des identités comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
