# Référence du livrable P273 État de la session de la base de données (Database Session State)

## Source analysée

- Fichier source : `../../../macroscope/livrables/425ca7d913bd.md`
...
- [[PEAA03] Patterns of Enterprise Application Architecture](javascript:openPopUp\('/DMRPFr/Html/Fr_P_383_99_RPP.html'\);) Voir aussi le catalogue des modèles de conception de l'auteur sur le web (anglais) : P of EAA Catalog
...
- Présenter P273 État de la session de la base de données (Database Session State) comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
