# Référence du livrable P276 Modèle du domaine

## Source analysée

- Fichier source : `../../../macroscope/livrables/8faf54071830.md`
...
- Modèle d'objet qui incorpore le comportement et les données du domaine.
...
- Présenter P276 Modèle du domaine comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
