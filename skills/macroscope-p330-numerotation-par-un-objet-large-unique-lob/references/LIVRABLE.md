# Référence du livrable P330 Numérotation par un objet large unique (LOB)

## Source analysée

- Fichier source : `../../../macroscope/livrables/939cce7e6c2b.md`
...
- Présenter P330 Numérotation par un objet large unique (LOB) comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
