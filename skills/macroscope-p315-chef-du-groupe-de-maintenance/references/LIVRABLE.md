# Référence du livrable P315 chef du groupe de maintenance

## Source analysée

- Fichier source : `../../../macroscope/livrables/8b87ced6bbe9.md`
- Méthode source : Macroscope
- Extraction du titre : code technique extrait de URL

## Synthèse du livrable

Le chef du groupe de maintenance gère le budget et les ressources du groupe de maintenance, et préside le comité de contrôle des changements. Le groupe de maintenance est habituellement responsable d'un portefeuille d'applications spécifique.
...
- Présenter P315 chef du groupe de maintenance comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
