# Référence du livrable P711U Manuel du formateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/8907c12b6f2b.md`
...
1. **1. Ébauche de l'événement d'apprentissage - Formateur** **2. Unités d'apprentissage - Formateur** 2.1 Unité d'apprentissage - Formateur (une section par unité d'apprentissage)
...
- Présenter P711U Manuel du formateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
