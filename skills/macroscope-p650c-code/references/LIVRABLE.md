# Référence du livrable P650C Code

## Source analysée

- Fichier source : `../../../macroscope/livrables/1fbc6fdc5a0c.md`
...
- * Produire les composants logiciels ayant rapport aux traitements d'un système.
...
- Présenter P650C Code comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
