# Référence du livrable P272 Objet de transfert de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/de3dc7a7fd17.md`
...
- Objet qui transfert les données entre les processus afin de réduire le nombre d'appels de méthodes.
...
- Présenter P272 Objet de transfert de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
