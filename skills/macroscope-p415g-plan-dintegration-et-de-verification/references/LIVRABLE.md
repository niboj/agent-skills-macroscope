# Référence du livrable P415G Plan d'intégration et de vérification

## Source analysée

- Fichier source : `../../../macroscope/livrables/ede7e35affcb.md`
...
1. **1. Ordonnancement des sous-livraisons** **2. Sous-livraisons** 2.1 Sous-livraison (une section par sous-livraison)

## Champs ou sections attendus

- **1. Ordonnancement des sous-livraisons** **2. Sous-livraisons** 2.1 Sous-livraison (une section par sous-livraison)

## Objets documentés

- * Organiser le processus permettant d'effectuer l'intégration et les essais.
...
- Présenter P415G Plan d'intégration et de vérification comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
