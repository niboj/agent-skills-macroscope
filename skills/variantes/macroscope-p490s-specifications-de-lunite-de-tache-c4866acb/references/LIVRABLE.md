...
- `../../../macroscope/livrables/c4866acb371f.md`
- `../../../macroscope/livrables/e029a2e358e8.md`
...
- Composantes d'interface utilisateur** 4.1 Composante d'interface utilisateur (une section par composante d'interface non réutilisable) **5.
- Perspective locale de l'unité de tâche** 5.1 Présentation de la perspective locale 5.2 Liste de services et de composantes **A.
