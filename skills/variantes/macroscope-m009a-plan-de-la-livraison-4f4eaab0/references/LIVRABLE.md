# Référence du livrable M009A Plan de la livraison

## Source analysée

- Fichier source : `../../../macroscope/livrables/4f4eaab0249c.md`
- Méthode source : Macroscope
- Extraction du titre : premier lien codé du fichier

## Synthèse du livrable

Le plan de la livraison est confirmé et ajusté au besoin : * L'objectif de la livraison est confirmé. * La séquence des itérations planifiées pour la livraison et, pour chaque itération, le thème;) et les items;) à développer, sont confirmés. * Les items, leur complexité, et les estimations de l'effort connexe sont confirmés. * Le plan global de la livraison est confirmé.
...
- * Conseiller en architecture de système: Contribue
...
- Domaine d’architecture principal : cadrage.
...
- Présenter M009A Plan de la livraison comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
...
Voici le ou les livrables ou documents à consulter au moment de réaliser cette activité : M009A - Plan de la livraison P200A - Cadre d'architecture
...
* Analyste-programmeur principal: Contribue * Expert du domaine: Contribue * Pilote: Contribue * Analyste-programmeur: Contribue * Chef de projet: Produit * Conseiller en architecture de système: Contribue * Comité de direction du projet: Approuve
