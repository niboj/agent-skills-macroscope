# Référence du livrable P560C Interface, niveau réalisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/af9eddf2f078.md`
...
1. **1. Description de l'interface, niveau réalisateur**
...
- * Définir un ensemble de conventions d'appel s'appliquant à un sous-système de niveau réalisateur, à un module, à une classe ou à un progiciel de niveau réalisateur.
- Description de l'interface, niveau réalisateur**
...
- Présenter P560C Interface, niveau réalisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
