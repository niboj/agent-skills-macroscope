# Référence du livrable P332 Couche de services

## Source analysée

- Fichier source : `../../../macroscope/livrables/e0fccb3f8344.md`
...
- Définit les frontières d'une application avec une couche de services qui établit un ensemble d'opérations disponibles et coordonne la réponse de l'application à l'intérieur de chaque opération.
...
- Présenter P332 Couche de services comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
