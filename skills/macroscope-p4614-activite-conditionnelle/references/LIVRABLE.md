# Référence du livrable P4614 Activité conditionnelle

## Source analysée

- Fichier source : `../../../macroscope/livrables/916dbcd70bed.md`
- Méthode source : Macroscope
- Extraction du titre : code technique extrait de URL

## Synthèse du livrable

L'activité conditionnelle exprime que la réalisation de certaines activités peut être assujettie à des conditions.
...
- #### Notation d'une activité conditionnelle (forme syntaxique simple) (Conventions de description des traitements)
...
- Présenter P4614 Activité conditionnelle comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
...
- La technique introduit les préconditions par des clauses conditionnelles du genre «Si condition», comme le montre l'exemple suivant.
