# Référence du livrable P-UIS.7 Évaluation des règles d'interface utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/8c8f0dfa064c.md`
- Méthode source : Macroscope
- Extraction du titre : lien inverse par URL

## Synthèse du livrable

L'évaluation, ici, porte sur les prototypes réalisés. On décide alors de la nécessité de procéder à des itérations supplémentaires.
...
- Présenter P-UIS.7 Évaluation des règles d'interface utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
