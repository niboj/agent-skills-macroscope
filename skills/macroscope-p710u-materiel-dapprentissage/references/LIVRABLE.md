# Référence du livrable P710U Matériel d'apprentissage

## Source analysée

- Fichier source : `../../../macroscope/livrables/1c67919ed491.md`
...
1. **1. Plan de l'événement d'apprentissage - Apprenant** **2. Unités d'apprentissage - Apprenant** 2.1 Unité d'apprentissage - Apprenant (une section par unité d'apprentissage)
...
- Présenter P710U Matériel d'apprentissage comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
