# Référence du livrable P600C Langage de définition des bases de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/2f57fbc29234.md`
...
1. **1. Langage de définition des bases de données**
...
- Langage de définition des bases de données**
...
- Présenter P600C Langage de définition des bases de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
