# Référence du livrable P268 Contrôleur

## Source analysée

- Fichier source : `../../../macroscope/livrables/d58abfb9491c.md`
...
- Le modèle de conception Contrôleur assigne la responsabilité de traiter avec les événements du système à une classe autre qu'une classe d'interface utilisateur.
- Cette classe représente l'ensemble du système ou un scénario de cas d'utilisation.
...
- Présenter P268 Contrôleur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
