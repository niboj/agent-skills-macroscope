# Référence du livrable P186S Spécifications de composante réutilisable d'interface

## Sources analysées

- `../../../macroscope/livrables/67401548bf03.md`
- `../../../macroscope/livrables/ae157dd3af27.md`
...
1. 1 Évaluation du prototype (une section par prototype)

## Champs ou sections attendus

- 1 Évaluation du prototype (une section par prototype)

## Objets documentés

- * Définir une composante d'interface utilisateur réutilisable, ses attributs et ses services.
- Survol de la composante d'interface utilisateur** **2.
- Description détaillée de la composante** 2.1 Présentation 2.2 Description de la composante 2.3 Service d'interface utilisateur (une section par service d'interface) **A.
...
- Présenter P186S Spécifications de composante réutilisable d'interface comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
