# Référence du livrable P-UIC.1 Analyse des critères de facilité d'utilisation des unités de tâche

## Source analysée

- Fichier source : `../../../macroscope/livrables/89a71f557f00.md`
...
- Lorsque ces critères s'appliquent à l'ensemble des unités de tâche, on les inclut dans les critères de qualité généraux du système.
...
- Présenter P-UIC.1 Analyse des critères de facilité d'utilisation des unités de tâche comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
