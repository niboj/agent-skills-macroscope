# Référence du livrable P286 Passerelle

## Source analysée

- Fichier source : `../../../macroscope/livrables/bc7e33cf9f65.md`
...
- [[PEAA03] Patterns of Enterprise Application Architecture](javascript:openPopUp\('/DMRPFr/Html/Fr_P_383_99_RPP.html'\);) Voir aussi le catalogue des modèles de conception de l'auteur sur le web (anglais) : [P of EAA Catalog](http://martinfowler.com/eaaCatalog/
...
- Présenter P286 Passerelle comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
