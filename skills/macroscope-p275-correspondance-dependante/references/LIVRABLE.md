# Référence du livrable P275 Correspondance dépendante

## Source analysée

- Fichier source : `../../../macroscope/livrables/993ffc1dfdfb.md`
...
- A une classe qui réalise la mise en concordance (mappage) d'une base de données pour une classe enfant.
...
- Présenter P275 Correspondance dépendante comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
