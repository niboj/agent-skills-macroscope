# Référence du livrable P410G Groupes d'intégration et d'essai

## Source analysée

- Fichier source : `../../../macroscope/livrables/e36193edabf2.md`
...
1. **1. Description des groupes d'intégration et d'essai d'un système** **2. Groupes d'intégration et d'essai d'un système(une section par groupe d'intégration et d'essai) **
...
- Description des groupes d'intégration et d'essai d'un système** **2.
- Groupes d'intégration et d'essai d'un système(une section par groupe d'intégration et d'essai) **
...
- Présenter P410G Groupes d'intégration et d'essai comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
