# Référence du livrable P313 Verrou pessimiste hors-ligne

## Source analysée

- Fichier source : `../../../macroscope/livrables/b4a1d351c0f6.md`
...
- Alloue l'accès aux données à une seule transaction d'affaires à la fois.
...
- Présenter P313 Verrou pessimiste hors-ligne comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
