# Référence du livrable P810G Partition en groupes d'acceptation

## Source analysée

- Fichier source : `../../../macroscope/livrables/f082909e9747.md`
...
1. **1. Ordonnancement des essais d'acceptation** **2. Définition des groupes d'essai d'acceptation** **3. Interdépendances entre les groupes d'essai**
...
- Présenter P810G Partition en groupes d'acceptation comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
