# Référence du livrable P229C Interfaces du sous-système, niveau réalisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/8516250880a3.md`
...
- Description de l'interface de sous-système, niveau réalisateur(une section par interface de sous-système, niveau réalisateur) ** 1.1 Liste des interfaces du sous-système, niveau réalisateur
...
- Présenter P229C Interfaces du sous-système, niveau réalisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
