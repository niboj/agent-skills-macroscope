# Référence du livrable P302 Faible couplage

## Source analysée

- Fichier source : `../../../macroscope/livrables/7375d1b207f3.md`
...
- Le Faible couplage est un modèle de conception d'évaluation dictant la façon de répartir les responsabilités en s'appuyant sur les principes de faible dépendance entre les classes, d'impacts limités dans une classe lors des changements dans d'autres classes et
...
- Présenter P302 Faible couplage comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
