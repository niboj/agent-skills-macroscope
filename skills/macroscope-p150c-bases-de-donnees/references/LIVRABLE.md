# Référence du livrable P150C Bases de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/3b912cdbf82c.md`
...
1. **1. Description des bases de données**
...
- Présenter P150C Bases de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
