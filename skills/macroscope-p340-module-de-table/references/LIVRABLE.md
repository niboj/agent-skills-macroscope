# Référence du livrable P340 Module de table

## Source analysée

- Fichier source : `../../../macroscope/livrables/bb5c2188aadb.md`
...
- Une instance unique qui manipule la logique d'affaires pour chaque rangée d'une table ou vue d'une base de données.
...
- Présenter P340 Module de table comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
