# Référence du livrable P415S Livrable Macroscope

## Sources analysées

- `../../../macroscope/livrables/bc13d4f85c96.md`
- `../../../macroscope/livrables/de006989327f.md`
...
1. **1. Portée** **2. Ordonnancement des groupes d'essai** **3. Détails d'exécution des essais(une section par niveau d'essai) **
...
- Présenter P415S Livrable Macroscope comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
