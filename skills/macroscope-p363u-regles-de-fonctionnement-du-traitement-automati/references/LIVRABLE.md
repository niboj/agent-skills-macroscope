# Référence du livrable P363U Règles de fonctionnement du traitement automatisé

## Source analysée

- Fichier source : `../../../macroscope/livrables/5cab752a4b3d.md`
...
1. **1. Règles de fonctionnement du traitement entièrement automatisé** **2. Règles de fonctionnement de l'interface système**
...
- Règles de fonctionnement du traitement entièrement automatisé** **2.
- Règles de fonctionnement de l'interface système**
...
- Présenter P363U Règles de fonctionnement du traitement automatisé comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
