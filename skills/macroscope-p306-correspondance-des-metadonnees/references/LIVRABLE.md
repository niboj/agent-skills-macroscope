# Référence du livrable P306 Correspondance des métadonnées

## Source analysée

- Fichier source : `../../../macroscope/livrables/c5ec192b7346.md`
...
- Contient dans les métadonnées les détails de la correspondance relationnel-objet.
...
- Présenter P306 Correspondance des métadonnées comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
