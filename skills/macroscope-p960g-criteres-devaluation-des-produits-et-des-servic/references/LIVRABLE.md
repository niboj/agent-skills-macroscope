# Référence du livrable P960G Critères d'évaluation des produits et des services

## Source analysée

- Fichier source : `../../../macroscope/livrables/e65df0bdf975.md`
...
1. **1. Aspects considérés** 1.1 Aspect considéré (une section par aspect) **2. Groupes de validation** 2.1 Groupe de validation (une section par groupe de validation)
...
- Présenter P960G Critères d'évaluation des produits et des services comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
