# Référence du livrable P510C Structure de la base de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/4496bc7e59c2.md`
...
1. **1. Description de la structure de la base de données** **2. Tables de la base de données** 2.1 Table de la base de données (une section par table de la base de données)
...
- Description de la structure de la base de données** **2.
- Tables de la base de données** 2.1 Table de la base de données (une section par table de la base de données)
...
- Présenter P510C Structure de la base de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
