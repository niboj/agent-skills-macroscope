# Référence du livrable P-UIC.5 Évaluation des composantes de l'interface utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/e7004e8016f8.md`
...
- Présenter P-UIC.5 Évaluation des composantes de l'interface utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
