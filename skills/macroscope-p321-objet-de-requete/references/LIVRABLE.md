# Référence du livrable P321 Objet de requête

## Source analysée

- Fichier source : `../../../macroscope/livrables/a730c306a91a.md`
...
- Objet qui représente une requête de base de données.
- Relationnel-objet; Correspondance des métadonnées

## Tableaux, modèles ou diagrammes recommandés

- Voir aussi le catalogue des modèles de conception de l'auteur sur le web (anglais) : [P of EAA Catalog](http://martinfowler.com/eaaCatalog/queryObject.html "Avis de non-responsabilité : Ce lien hypertextuel mène à une adresse externe.
...
- Présenter P321 Objet de requête comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
