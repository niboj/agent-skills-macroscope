# Référence du livrable P365U Règles de fonctionnement des services du noyau

## Source analysée

- Fichier source : `../../../macroscope/livrables/60ea8bd54987.md`
...
1. **1. Règles de fonctionnement des services du noyau**
...
- Règles de fonctionnement des services du noyau**
...
- Présenter P365U Règles de fonctionnement des services du noyau comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
