# Référence du livrable P282 Fabrique concrète

## Source analysée

- Fichier source : `../../../macroscope/livrables/9ec0e2217e30.md`
...
- Définit une interface pour créer un objet, mais laisse les sous-classes décider quelles classes instancier.

## Tableaux, modèles ou diagrammes recommandés

- Le modèle Fabrique reporte l'instantiation d'une classe aux sous-classes.
...
- Présenter P282 Fabrique concrète comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
