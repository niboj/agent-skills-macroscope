# Référence du livrable P200O Livrable Macroscope

## Source analysée

- Fichier source : `../../../macroscope/livrables/e209b3c8c2c6.md`
...
1. **1. Description de la structure du système d'information** **2. Sous-systèmes d'information** 2.1 Sous-système d'information (une section par sous-système d'information)
...
- Description de la structure du système d'information** **2.
- Sous-systèmes d'information** 2.1 Sous-système d'information (une section par sous-système d'information)
...
- Présenter P200O Livrable Macroscope comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
