# Référence du livrable P280U Analyse des impacts, niveau utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/452ea190fdb2.md`
...
- Impacts sur les systèmes, niveau utilisateur** 2.1 Impacts sur le système, niveau utilisateur (une section par système d'information)
...
- Présenter P280U Analyse des impacts, niveau utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
