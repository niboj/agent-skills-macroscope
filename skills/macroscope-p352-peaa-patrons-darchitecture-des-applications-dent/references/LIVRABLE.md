# Référence du livrable P352 PEAA - Patrons d'architecture des applications d'entreprise

## Source analysée

- Fichier source : `../../../macroscope/livrables/6065602bd8b1.md`
...
- Enregistrement actif Contrôleur d'application Table de correspondance des associations Table d'héritage des classes État de la session client Verrou grossier Table concrète d'héritage Mapper de données Objet de transfert de données État de la session de la bas
...
- Présenter P352 PEAA - Patrons d'architecture des applications d'entreprise comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
