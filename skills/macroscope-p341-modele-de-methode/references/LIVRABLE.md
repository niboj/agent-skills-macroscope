# Référence du livrable P341 Modèle de méthode

## Source analysée

- Fichier source : `../../../macroscope/livrables/8d8e0649257b.md`
...
- Le patron Modèle de méthode laisse les sous-classes redéfinir certaines étapes sans changer la structure de l'algorithme.
...
- Présenter P341 Modèle de méthode comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
