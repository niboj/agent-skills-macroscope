...
| --- | --- |
| Code | P510S |
| Nom | Structure de l'information persistante |
...
<!-- - Modèle des bases de données** 3.1 Base de données (une section pour chaque base de données impliquées dans le système d'information) -->
