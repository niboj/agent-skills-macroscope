# Référence du livrable P269 Coordonnateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/cf60b8ff0589.md`
...
- Décrit comment maintenir la cohérence du système en coordonnant l'achèvement de tâches qui impliquent des participants multiples, chacun pouvant inclure une ressource, un utilisateur de ressource et un fournisseur de ressource.

## Tableaux, modèles ou diagrammes recommandés

- Le modèle présente une solution tel que le travail fait par l'ensemble des participants impliqués est complété ou rien n'est fait.
...
- Présenter P269 Coordonnateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
