# Référence du livrable P740C Environnement d'essai d'intégration

## Source analysée

- Fichier source : `../../../macroscope/livrables/a67f7712ed46.md`
...
1. **1. Techniques et outils d'essai d'intégration** **2. Configuration de l'environnement d'essai d'intégration**
...
- Présenter P740C Environnement d'essai d'intégration comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
