# Référence du livrable P750G Cas d'essai d'intégration

## Source analysée

- Fichier source : `../../../macroscope/livrables/3d7fd613bb21.md`
...
1. **1. Description du groupe d'essai** **2. Domaines d'essai** 2.1 Description du domaine d'essai (une section par domaine d'essai) 2.2 Cas d'essai (une section par cas d'essai)
...
- Présenter P750G Cas d'essai d'intégration comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
