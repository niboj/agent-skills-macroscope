# Référence du livrable P271 Mapper de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/3f54c705e94c.md`
...
- Couche de mappers qui permet la manipulation du contenu des objets et d'une base de données tout en les gardant indépendant l'un de l'autre et du mapper lui-même.
- Établit un lien de correspondance entre un contenant de données en mémoire vive et une base de données.
- Source de données
...
- Présenter P271 Mapper de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
