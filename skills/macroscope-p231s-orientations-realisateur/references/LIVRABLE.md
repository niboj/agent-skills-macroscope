# Référence du livrable P231S Orientations réalisateur

## Sources analysées

- `../../../macroscope/livrables/62ebcdc0cb85.md`
- `../../../macroscope/livrables/f29f43146232.md`
...
- * Évaluer les options en ce qui a trait aux principaux concepts et composantes réalisateur.
...
- Présenter P231S Orientations réalisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
