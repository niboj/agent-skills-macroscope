# Référence du livrable P328 Passerelle des rangées de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/b69c537510bc.md`
...
- Objet qui agit comme une passerelle pour un seul enregistrement dans une source de données (data source).
- Source de données
...
- Présenter P328 Passerelle des rangées de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
