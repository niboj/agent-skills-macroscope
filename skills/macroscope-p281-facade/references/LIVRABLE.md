# Référence du livrable P281 Façade

## Source analysée

- Fichier source : `../../../macroscope/livrables/f27711ec451b.md`
...
- Fournit une interface unifiée à un ensemble d'interfaces d'un sous-système.
- Le modèle Façade définit une interface de haut niveau qui facilite l'utilisation du sous-système.
...
- Présenter P281 Façade comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
