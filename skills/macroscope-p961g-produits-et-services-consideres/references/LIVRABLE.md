# Référence du livrable P961G Produits et services considérés

## Source analysée

- Fichier source : `../../../macroscope/livrables/44b7ff292213.md`
...
- Produits et services** 1.1 Produit ou service (une section par produit ou service) **2.
- Configurations des produits et des services** 2.1 Configuration des produits et des services (une section par configuration) **3.
- Recommandation relative aux produits et aux services**
...
- Présenter P961G Produits et services considérés comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
