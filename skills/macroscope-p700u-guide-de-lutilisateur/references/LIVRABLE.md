# Référence du livrable P700U Guide de l'utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/e6dff2ec3e8f.md`
...
1. **1. Survol du guide de l'utilisateur** **2. Processus** 2.1 Processus (une section par processus)

## Champs ou sections attendus

- **1. Survol du guide de l'utilisateur** **2. Processus** 2.1 Processus (une section par processus)

## Objets documentés

- * Fournir une description détaillée des actions devant être effectuées par les utilisateurs pour faire fonctionner le système dans une circonstance d'utilisation précise.
- Processus** 2.1 Processus (une section par processus)
...
- Présenter P700U Guide de l'utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
