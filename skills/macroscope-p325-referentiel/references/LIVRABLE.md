# Référence du livrable P325 Référentiel

## Source analysée

- Fichier source : `../../../macroscope/livrables/1085b4097394.md`
...
- Voir aussi le catalogue des modèles de conception de l'auteur sur le web (anglais) : [P of EAA Catalog](http://martinfowler.com/eaaCatalog/repository.html "Avis de non-responsabilité : Ce lien hypertextuel mène à une adresse externe.
...
- Présenter P325 Référentiel comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
