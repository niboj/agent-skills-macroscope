# Référence du livrable P314 groupe de maintenance

## Source analysée

- Fichier source : `../../../macroscope/livrables/f8c58cde8dbd.md`
- Méthode source : Macroscope
- Extraction du titre : code technique extrait de URL

## Synthèse du livrable

Ce groupe est responsable des activités courantes d'exploitation et de la maintenance d'un portefeuille d'applications.
...
- Présenter P314 groupe de maintenance comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
