# Référence du livrable P-UIAP.6 Évaluation des orientations et principes d'interface utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/55b4eeb3b064.md`
...
- Présenter P-UIAP.6 Évaluation des orientations et principes d'interface utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
