# Référence du livrable P240U Principes, niveau utilisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/4d72a4f6e251.md`
...
- Principes de fonctionnement de l'interface utilisateur** **4.
- Principes de fonctionnement du traitement automatisé** **5.
- Principes de fonctionnement des services du noyau** **6.
- Principes de contrôle du fonctionnement** **7.
...
- Présenter P240U Principes, niveau utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
