# Référence du livrable P4615 Répétition conditionnelle

## Source analysée

- Fichier source : `../../../macroscope/livrables/c997a674bf44.md`
...
- Présenter P4615 Répétition conditionnelle comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
...
- On peut aussi exprimer la répétition, c'est-à-dire qu'une activité peut se répéter et cette même activité porte alors sur plusieurs instances, comme l'indique l'exemple suivant.
