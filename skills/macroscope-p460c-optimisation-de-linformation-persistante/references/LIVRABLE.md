# Référence du livrable P460C Optimisation de l'information persistante

## Source analysée

- Fichier source : `../../../macroscope/livrables/ee0d26a217f5.md`
...
- Liens** 3.1 Description du lien (une section par lien relatif à l'accès aux données)
...
- Présenter P460C Optimisation de l'information persistante comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
