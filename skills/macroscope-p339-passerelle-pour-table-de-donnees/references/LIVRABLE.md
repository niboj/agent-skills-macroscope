# Référence du livrable P339 Passerelle pour table de données

## Source analysée

- Fichier source : `../../../macroscope/livrables/7e55604a41cf.md`
...
- Objet qui agit comme passerelle pour une table d'une base de données.
- Source de données
...
- Présenter P339 Passerelle pour table de données comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
