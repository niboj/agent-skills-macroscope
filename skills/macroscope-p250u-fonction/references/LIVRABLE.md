# Référence du livrable P250U Fonction

## Source analysée

- Fichier source : `../../../macroscope/livrables/aa9eebf55ceb.md`
...
1. **1. Description de la fonction** **2. Unités de tâche** 2.1 Unité de tâche (une section par unité de tâche)

## Champs ou sections attendus

- **1. Description de la fonction** **2. Unités de tâche** 2.1 Unité de tâche (une section par unité de tâche)
...
- Présenter P250U Fonction comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
