# Référence du livrable P291 Indirection

## Source analysée

- Fichier source : `../../../macroscope/livrables/aaa48f5dabdd.md`
...
- Le modèle de conception Indirection prend en charge le faible couplage (et le potentiel de réutilisation) entre deux éléments en attribuant la responsabilité de la médiation entre eux à un objet intermédiaire.
...
- Présenter P291 Indirection comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
