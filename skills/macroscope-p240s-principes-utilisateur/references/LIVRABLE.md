# Référence du livrable P240S Principes utilisateur

## Sources analysées

- `../../../macroscope/livrables/62bbbf5d9e34.md`
- `../../../macroscope/livrables/74fcefb4c9d3.md`
...
- Principes de l'interface utilisateur** **4.
- Principes de fonctionnement du traitement automatisé** **5.
- Principes de contrôle du système en exploitation** **7.
...
- Présenter P240S Principes utilisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
