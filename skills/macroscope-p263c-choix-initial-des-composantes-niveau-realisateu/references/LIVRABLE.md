# Référence du livrable P263C Choix initial des composantes, niveau réalisateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/7c2970f55bbc.md`
...
1. **1. Recensement des composantes, niveau réalisateur**
...
- Recensement des composantes, niveau réalisateur**
...
- Domaine d’architecture principal : architecture technologique.
- Artefacts associés : Composant technologique, Plateforme, Vue de déploiement.

## Règles particulières de rédaction

- Présenter P263C Choix initial des composantes, niveau réalisateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
