# Référence du livrable P830G Cas d'essai d'acceptation

## Source analysée

- Fichier source : `../../../macroscope/livrables/3659b9f70c19.md`
...
1. **1. Description du groupe d'essai d'acceptation** **2. Cas d'essai d'acceptation(une section par cas d'essai d'acceptation) **
...
- Présenter P830G Cas d'essai d'acceptation comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
