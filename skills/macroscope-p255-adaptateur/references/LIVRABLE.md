# Référence du livrable P255 Adaptateur

## Source analysée

- Fichier source : `../../../macroscope/livrables/bf09174335ac.md`
...
- L'adaptateur permet aux classes de travailler ensemble alors qu'elles ne pourraient pas autrement à cause d'une incompatibilité d'interfaces.
...
- Présenter P255 Adaptateur comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
