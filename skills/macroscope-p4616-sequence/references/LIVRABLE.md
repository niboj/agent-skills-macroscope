# Référence du livrable P4616 Séquence

## Source analysée

- Fichier source : `../../../macroscope/livrables/3ec20ed18cac.md`
- Méthode source : Macroscope
- Extraction du titre : code technique extrait de URL

## Synthèse du livrable

La séquence est l'enchaînement strict des activités. Une activité peut elle-même être composée d'activités (y compris des activités conditionnelles ou répétées).
...
- #### Notation d'une séquence (forme syntaxique simple) (Conventions de description des traitements)
...
- Présenter P4616 Séquence comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
...
- #### Exemples
- #### Exemple de séquence
- Par exemple, la séquence d'activités A, B et C s'exécute dans l'ordre.
- Exemple de séquence
