# Référence du livrable P275S Stratégie de changement organisationnel

## Sources analysées

- `../../../macroscope/livrables/8c40947df6cd.md`
- `../../../macroscope/livrables/9742b80d9697.md`
...
- Consolidation de la stratégie administrative et organisationnelle de sécurité**
...
- Livrable TOGAF cible : Spécification des exigences d’architecture (Architecture Requirements Specification).
- Domaine d’architecture principal : sécurité.
...
- Présenter P275S Stratégie de changement organisationnel comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
