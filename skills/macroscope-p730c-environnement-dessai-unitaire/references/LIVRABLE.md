# Référence du livrable P730C Environnement d'essai unitaire

## Source analysée

- Fichier source : `../../../macroscope/livrables/574c405a79b3.md`
...
1. **1. Techniques et outils d'essai unitaire** **2. Configuration de l'environnement d'essai unitaire**
...
- Présenter P730C Environnement d'essai unitaire comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
