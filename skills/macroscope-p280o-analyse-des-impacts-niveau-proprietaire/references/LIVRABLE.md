# Référence du livrable P280O Analyse des impacts, niveau propriétaire

## Source analysée

- Fichier source : `../../../macroscope/livrables/3e495bb6f9cc.md`
...
- Impacts sur les systèmes, niveau propriétaire** 2.1 Impacts sur le système, niveau propriétaire (une section par système d'information)
...
- Présenter P280O Analyse des impacts, niveau propriétaire comme un artefact, une vue spécialisée, un gabarit ou une annexe d’architecture de service alignée sur TOGAF.
